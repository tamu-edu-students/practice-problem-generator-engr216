...
class ParticleStaticsProblemGenerator
    ...
    def static_questions
      questions = [
        {
          question: 'A 10 kg object is suspended by two cables. What is the tension in each cable if the system is in equilibrium?',
          answer: ['49', '49'],
          input_type: 'fill_in',
          field_label: 'Tension (N)'
        },
        {
          question: 'A 5 m beam is supported at both ends. A 500 N weight is placed 2 m from the left end. What is the reaction force at the left support?',
          answer: '300',
          input_type: 'fill_in',
          field_label: 'Left Support Force (N)'
        },
        {
          question: 'A ladder leans against a frictionless wall. What must be the minimum coefficient of friction at the base to prevent slipping?',
          answer: '0.45',
          input_type: 'fill_in',
    ...
    def dynamic_question_one
      ...
      generate_ps_problem_from_data({
        question: "A mass of #{mass} kg is suspended symmetrically by two vertical ropes. " \
    ...
    def dynamic_question_two
      ...
      generate_ps_problem_from_data({
        question: "A force of #{force} N is applied at a perpendicular distance of #{distance} m from a pivot. " \
