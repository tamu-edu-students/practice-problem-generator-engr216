...
module CollisionProblemGenerators
  def generate_bullet_block_question
    ...
    build_collision_problem(question, bullet_mass, bullet_initial_speed, bullet_final_speed, block_mass)
  end

  def generate_electron_collision_question
    mass_ratio = rand(100..200)
    question = electron_collision_question_text(mass_ratio)
    build_collision_problem(question, mass_ratio)
  end
  ...
  def generate_ball_drop_question
    ...
    build_collision_problem(question, ball1_mass, ball2_mass, drop_height)
  end
  ...
  def generate_car_collision_question
    ...
    build_collision_problem(question, car1_mass, car1_speed, car2_mass, car2_speed)
  end
  ...
  def generate_pool_ball_question
    ...
    build_collision_problem(question, ball_mass, initial_speed, angle)
  end
  ...
  def generate_pendulum_collision_question
    ...
    build_collision_problem(question, pendulum1_mass, pendulum2_mass, pendulum1_height)
  end
  ...
  def generate_puck_collision_question
    ...
    build_collision_problem(question, puck1_mass, puck1_speed, puck2_mass)
  end
  ...
  def generate_projectile_collision_question
    ...
    build_collision_problem(question, projectile_mass, target_mass, projectile_speed)
  end
  ...
  def generate_falling_object_question
    ...
    build_collision_problem(question, object1_mass, object2_mass, initial_height, restitution)
  end
end
